...
| Feature | Free | Keeper | Keeper Pro | BinKeeper Move |
|---|---|---|---|---|
...
- **After expiry:** Account returns to Free tier. All bins and items preserved in read-only state.
...
Available on Free and Keeper tiers. Not needed on Pro or Move (both have unlimited items).
...
- **Item limit:** Enforced at item creation within a bin. Free tier cap is 10 items/bin; Keeper cap is 40 items/bin. App surfaces an upgrade prompt or add-on purchase option at this moment.
- **AI scan limit (Free):** 5 scans lifetime. Once used, AI scanning is locked permanently unless user upgrades to Pro or purchases Move.
...
- **Move expiry:** At 30 days, account silently downgrades to Free. Data preserved read-only. Neutral message shown: "Your BinKeeper Move period has ended. Visit binkeeperapp.com to keep your data accessible."
